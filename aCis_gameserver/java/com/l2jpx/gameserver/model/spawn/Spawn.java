package com.l2jpx.gameserver.model.spawn;
...
public final class Spawn implements Runnable
{
	...
	public Spawn(NpcTemplate template) throws SecurityException, ClassNotFoundException, NoSuchMethodException
	{
		...
		{
			int.class,
			Class.forName("com.l2jpx.gameserver.model.actor.template.NpcTemplate")
		};
		_constructor = Class.forName("com.l2jpx.gameserver.model.actor.instance." + _template.getType()).getConstructor(parameters);
	}
