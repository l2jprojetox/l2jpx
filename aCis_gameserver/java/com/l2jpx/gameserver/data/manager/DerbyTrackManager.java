	...
	protected DerbyTrackManager()
	{
		...
		try
		{
			for (int i = 31003; i < 31027; i++)
			{
				...
				final Constructor<?> constructor = Class.forName("com.l2jpx.gameserver.model.actor.instance." + template.getType()).getConstructors()[0];
