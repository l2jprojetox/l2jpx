...
import com.l2jpx.commons.data.xml.IXmlReader;
...
import com.l2jpx.gameserver.model.zone.form.ZoneCuboid;
import com.l2jpx.gameserver.model.zone.form.ZoneCylinder;
import com.l2jpx.gameserver.model.zone.form.ZoneNPoly;
import com.l2jpx.gameserver.model.zone.type.BossZone;
import com.l2jpx.gameserver.model.zone.type.subtype.SpawnZoneType;
...
public class ZoneManager implements IXmlReader
{
	...
	public void parseDocument(Document doc, Path path)
	{
		...
		try
		{
			zoneConstructor = Class.forName("com.l2jpx.gameserver.model.zone.type." + zoneType).getConstructor(int.class);
		}
		catch (Exception e)
		{
