...
public final class Config
{
	...
	private static final void loadLogin()
	{
		...
		// essa config estava nos arquivos do GS e LS, mas o patch que temos da 407 removeu do GS
		// não sei se foi intencional, mas precisamos dela no LS para inciciar o ConnectionPool
