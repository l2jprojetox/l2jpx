...
import com.px.gameserver.model.zone.form.ZoneCuboid;
import com.px.gameserver.model.zone.form.ZoneCylinder;
import com.px.gameserver.model.zone.form.ZoneNPoly;
import com.px.gameserver.model.zone.type.BossZone;
import com.px.gameserver.model.zone.type.subtype.SpawnZoneType;
...
public class ZoneManager implements IXmlReader
{
	...
	public void parseDocument(Document doc, Path path)
	{
		...
		try
		{
			zoneConstructor = Class.forName("com.px.gameserver.model.zone.type." + zoneType).getConstructor(int.class);
		}
		catch (Exception e)
		{
