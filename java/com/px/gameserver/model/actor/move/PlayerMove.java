	...
	protected void moveToLocation(Location destination, boolean pathfinding)
	{
		...
		if (_isDebugMove)
		{
			...
			for (Player p : _actor.getSurroundingGMs())
			{
				...
				if (boat != null)
				{
					final Line2D entrance = boat.getEngine().getDock().getDockEntrance();
					
					// Add a WHITE line corresponding to the boat entrance.
					debug.addLine("Boat Entrance", Color.WHITE, true, entrance.getP1x(), entrance.getP1y(), -3624, entrance.getP2x(), entrance.getP2y(), -3624);
				}
