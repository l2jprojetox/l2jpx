 ...
 */
package org.l2jpx.gameserver.model.stats.functions;

import org.l2jpx.gameserver.enums.StatFunction;
...
public class FuncTemplate
{
	...
	public FuncTemplate(Condition attachCond, Condition applyCond, String functionName, int order, Stat stat, double value)
	{
		...
		try
		{
			_functionClass = Class.forName("org.l2jpx.gameserver.model.stats.functions.Func" + function.getName());
		}
