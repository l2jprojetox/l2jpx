 ...
 */
package org.l2jpx.gameserver.model.actor;
...
import org.l2jpx.commons.database.DatabaseFactory;
import org.l2jpx.commons.threads.ThreadPool;
import org.l2jpx.commons.util.Rnd;
import org.l2jpx.gameserver.LoginServerThread;
import org.l2jpx.gameserver.ai.CreatureAI;
import org.l2jpx.gameserver.ai.CreatureAI.IntentionCommand;
import org.l2jpx.gameserver.ai.CtrlIntention;
import org.l2jpx.gameserver.ai.PlayerAI;
import org.l2jpx.gameserver.ai.SummonAI;
import org.l2jpx.gameserver.cache.RelationCache;
import org.l2jpx.gameserver.communitybbs.BB.Forum;
import org.l2jpx.gameserver.communitybbs.Manager.ForumsBBSManager;
import org.l2jpx.gameserver.data.sql.CharInfoTable;
import org.l2jpx.gameserver.data.sql.CharSummonTable;
import org.l2jpx.gameserver.data.sql.ClanTable;
import org.l2jpx.gameserver.data.sql.OfflineTraderTable;
import org.l2jpx.gameserver.data.xml.AdminData;
import org.l2jpx.gameserver.data.xml.AttendanceRewardData;
import org.l2jpx.gameserver.data.xml.CategoryData;
import org.l2jpx.gameserver.data.xml.ClassListData;
import org.l2jpx.gameserver.data.xml.ExperienceData;
import org.l2jpx.gameserver.data.xml.HennaData;
import org.l2jpx.gameserver.data.xml.ItemData;
import org.l2jpx.gameserver.data.xml.NpcData;
import org.l2jpx.gameserver.data.xml.NpcNameLocalisationData;
import org.l2jpx.gameserver.data.xml.PetDataTable;
import org.l2jpx.gameserver.data.xml.PlayerTemplateData;
import org.l2jpx.gameserver.data.xml.PlayerXpPercentLostData;
import org.l2jpx.gameserver.data.xml.RecipeData;
import org.l2jpx.gameserver.data.xml.SendMessageLocalisationData;
import org.l2jpx.gameserver.data.xml.SkillData;
import org.l2jpx.gameserver.data.xml.SkillTreeData;
import org.l2jpx.gameserver.enums.AdminTeleportType;
import org.l2jpx.gameserver.enums.BroochJewel;
import org.l2jpx.gameserver.enums.CastleSide;
import org.l2jpx.gameserver.enums.CategoryType;
import org.l2jpx.gameserver.enums.ChatType;
import org.l2jpx.gameserver.enums.ClanWarState;
import org.l2jpx.gameserver.enums.ClassId;
import org.l2jpx.gameserver.enums.GroupType;
...
import org.l2jpx.gameserver.enums.ItemLocation;
import org.l2jpx.gameserver.enums.MountType;
import org.l2jpx.gameserver.enums.NextActionType;
import org.l2jpx.gameserver.enums.PartyDistributionType;
import org.l2jpx.gameserver.enums.PartyMessageType;
import org.l2jpx.gameserver.enums.PartySmallWindowUpdateType;
import org.l2jpx.gameserver.enums.PlayerAction;
import org.l2jpx.gameserver.enums.PlayerCondOverride;
import org.l2jpx.gameserver.enums.PrivateStoreType;
import org.l2jpx.gameserver.enums.Race;
import org.l2jpx.gameserver.enums.Sex;
import org.l2jpx.gameserver.enums.ShortcutType;
import org.l2jpx.gameserver.enums.SkillFinishType;
import org.l2jpx.gameserver.enums.StatusUpdateType;
import org.l2jpx.gameserver.enums.SubclassInfoType;
import org.l2jpx.gameserver.enums.Team;
import org.l2jpx.gameserver.enums.TeleportWhereType;
import org.l2jpx.gameserver.enums.UserInfoType;
import org.l2jpx.gameserver.geoengine.GeoEngine;
import org.l2jpx.gameserver.handler.IItemHandler;
import org.l2jpx.gameserver.handler.ItemHandler;
import org.l2jpx.gameserver.instancemanager.AntiFeedManager;
...
import org.l2jpx.gameserver.instancemanager.DimensionalRiftManager;
import org.l2jpx.gameserver.instancemanager.DuelManager;
import org.l2jpx.gameserver.instancemanager.FortManager;
import org.l2jpx.gameserver.instancemanager.FortSiegeManager;
import org.l2jpx.gameserver.instancemanager.IdManager;
import org.l2jpx.gameserver.instancemanager.ItemsOnGroundManager;
import org.l2jpx.gameserver.instancemanager.MatchingRoomManager;
import org.l2jpx.gameserver.instancemanager.MentorManager;
import org.l2jpx.gameserver.instancemanager.PunishmentManager;
import org.l2jpx.gameserver.instancemanager.QuestManager;
import org.l2jpx.gameserver.instancemanager.RecipeManager;
import org.l2jpx.gameserver.instancemanager.SellBuffsManager;
import org.l2jpx.gameserver.instancemanager.SiegeManager;
import org.l2jpx.gameserver.instancemanager.ZoneManager;
import org.l2jpx.gameserver.model.AccessLevel;
import org.l2jpx.gameserver.model.BlockList;
import org.l2jpx.gameserver.model.CommandChannel;
import org.l2jpx.gameserver.model.ContactList;
import org.l2jpx.gameserver.model.Duel;
import org.l2jpx.gameserver.model.Location;
import org.l2jpx.gameserver.model.Macro;
import org.l2jpx.gameserver.model.MacroList;
import org.l2jpx.gameserver.model.ManufactureItem;
import org.l2jpx.gameserver.model.Party;
import org.l2jpx.gameserver.model.PetData;
import org.l2jpx.gameserver.model.PetLevelData;
import org.l2jpx.gameserver.model.PremiumItem;
import org.l2jpx.gameserver.model.Radar;
import org.l2jpx.gameserver.model.RecipeList;
import org.l2jpx.gameserver.model.Request;
import org.l2jpx.gameserver.model.ShortCuts;
import org.l2jpx.gameserver.model.Shortcut;
import org.l2jpx.gameserver.model.SkillLearn;
import org.l2jpx.gameserver.model.TeleportBookmark;
import org.l2jpx.gameserver.model.TimeStamp;
import org.l2jpx.gameserver.model.TradeList;
import org.l2jpx.gameserver.model.World;
import org.l2jpx.gameserver.model.WorldObject;
import org.l2jpx.gameserver.model.actor.appearance.PlayerAppearance;
import org.l2jpx.gameserver.model.actor.instance.AirShip;
import org.l2jpx.gameserver.model.actor.instance.Boat;
import org.l2jpx.gameserver.model.actor.instance.ControlTower;
import org.l2jpx.gameserver.model.actor.instance.Defender;
import org.l2jpx.gameserver.model.actor.instance.Doppelganger;
import org.l2jpx.gameserver.model.actor.instance.FriendlyMob;
import org.l2jpx.gameserver.model.actor.instance.Guard;
import org.l2jpx.gameserver.model.actor.instance.Pet;
import org.l2jpx.gameserver.model.actor.instance.Shuttle;
import org.l2jpx.gameserver.model.actor.instance.TamedBeast;
import org.l2jpx.gameserver.model.actor.instance.Trap;
import org.l2jpx.gameserver.model.actor.request.AbstractRequest;
import org.l2jpx.gameserver.model.actor.request.SayuneRequest;
import org.l2jpx.gameserver.model.actor.stat.PlayerStat;
import org.l2jpx.gameserver.model.actor.status.PlayerStatus;
import org.l2jpx.gameserver.model.actor.tasks.player.DismountTask;
import org.l2jpx.gameserver.model.actor.tasks.player.FameTask;
import org.l2jpx.gameserver.model.actor.tasks.player.HennaDurationTask;
import org.l2jpx.gameserver.model.actor.tasks.player.InventoryEnableTask;
import org.l2jpx.gameserver.model.actor.tasks.player.PetFeedTask;
import org.l2jpx.gameserver.model.actor.tasks.player.RecoGiveTask;
import org.l2jpx.gameserver.model.actor.tasks.player.RentPetTask;
import org.l2jpx.gameserver.model.actor.tasks.player.ResetChargesTask;
import org.l2jpx.gameserver.model.actor.tasks.player.ResetSoulsTask;
import org.l2jpx.gameserver.model.actor.tasks.player.SitDownTask;
import org.l2jpx.gameserver.model.actor.tasks.player.StandUpTask;
import org.l2jpx.gameserver.model.actor.tasks.player.TeleportWatchdogTask;
import org.l2jpx.gameserver.model.actor.tasks.player.WarnUserTakeBreakTask;
import org.l2jpx.gameserver.model.actor.tasks.player.WaterTask;
import org.l2jpx.gameserver.model.actor.templates.PlayerTemplate;
import org.l2jpx.gameserver.model.actor.transform.Transform;
import org.l2jpx.gameserver.model.clan.Clan;
import org.l2jpx.gameserver.model.clan.ClanMember;
import org.l2jpx.gameserver.model.clan.ClanPrivilege;
import org.l2jpx.gameserver.model.clan.ClanWar;
import org.l2jpx.gameserver.model.cubic.Cubic;
import org.l2jpx.gameserver.model.effects.EffectFlag;
...
import org.l2jpx.gameserver.model.events.impl.creature.player.OnPlayableExpChanged;
import org.l2jpx.gameserver.model.events.impl.creature.player.OnPlayerAbilityPointsChanged;
import org.l2jpx.gameserver.model.events.impl.creature.player.OnPlayerFameChanged;
import org.l2jpx.gameserver.model.events.impl.creature.player.OnPlayerHennaAdd;
import org.l2jpx.gameserver.model.events.impl.creature.player.OnPlayerHennaRemove;
import org.l2jpx.gameserver.model.events.impl.creature.player.OnPlayerItemEquip;
import org.l2jpx.gameserver.model.events.impl.creature.player.OnPlayerLogin;
import org.l2jpx.gameserver.model.events.impl.creature.player.OnPlayerLogout;
import org.l2jpx.gameserver.model.events.impl.creature.player.OnPlayerMenteeStatus;
import org.l2jpx.gameserver.model.events.impl.creature.player.OnPlayerMentorStatus;
import org.l2jpx.gameserver.model.events.impl.creature.player.OnPlayerPKChanged;
import org.l2jpx.gameserver.model.events.impl.creature.player.OnPlayerProfessionCancel;
import org.l2jpx.gameserver.model.events.impl.creature.player.OnPlayerProfessionChange;
import org.l2jpx.gameserver.model.events.impl.creature.player.OnPlayerPvPChanged;
import org.l2jpx.gameserver.model.events.impl.creature.player.OnPlayerPvPKill;
import org.l2jpx.gameserver.model.events.impl.creature.player.OnPlayerReputationChanged;
import org.l2jpx.gameserver.model.events.impl.creature.player.OnPlayerSubChange;
import org.l2jpx.gameserver.model.events.listeners.FunctionEventListener;
import org.l2jpx.gameserver.model.events.returns.TerminateReturn;
import org.l2jpx.gameserver.model.events.timers.TimerHolder;
import org.l2jpx.gameserver.model.fishing.Fishing;
import org.l2jpx.gameserver.model.holders.AttendanceInfoHolder;
import org.l2jpx.gameserver.model.holders.AutoPlaySettingsHolder;
import org.l2jpx.gameserver.model.holders.AutoUseSettingsHolder;
import org.l2jpx.gameserver.model.holders.ItemHolder;
import org.l2jpx.gameserver.model.holders.MovieHolder;
import org.l2jpx.gameserver.model.holders.PreparedMultisellListHolder;
import org.l2jpx.gameserver.model.holders.SellBuffHolder;
import org.l2jpx.gameserver.model.holders.SkillHolder;
import org.l2jpx.gameserver.model.holders.SkillUseHolder;
import org.l2jpx.gameserver.model.holders.SubClassHolder;
import org.l2jpx.gameserver.model.holders.TrainingHolder;
import org.l2jpx.gameserver.model.instancezone.Instance;
import org.l2jpx.gameserver.model.interfaces.ILocational;
import org.l2jpx.gameserver.model.item.Armor;
import org.l2jpx.gameserver.model.item.EtcItem;
import org.l2jpx.gameserver.model.item.Henna;
import org.l2jpx.gameserver.model.item.ItemTemplate;
import org.l2jpx.gameserver.model.item.Weapon;
import org.l2jpx.gameserver.model.item.instance.Item;
import org.l2jpx.gameserver.model.item.type.ActionType;
import org.l2jpx.gameserver.model.item.type.ArmorType;
import org.l2jpx.gameserver.model.item.type.EtcItemType;
import org.l2jpx.gameserver.model.item.type.WeaponType;
import org.l2jpx.gameserver.model.itemcontainer.Inventory;
import org.l2jpx.gameserver.model.itemcontainer.ItemContainer;
import org.l2jpx.gameserver.model.itemcontainer.PetInventory;
import org.l2jpx.gameserver.model.itemcontainer.PlayerFreight;
import org.l2jpx.gameserver.model.itemcontainer.PlayerInventory;
import org.l2jpx.gameserver.model.itemcontainer.PlayerRefund;
import org.l2jpx.gameserver.model.itemcontainer.PlayerWarehouse;
import org.l2jpx.gameserver.model.matching.MatchingRoom;
import org.l2jpx.gameserver.model.olympiad.Hero;
import org.l2jpx.gameserver.model.olympiad.OlympiadGameManager;
import org.l2jpx.gameserver.model.olympiad.OlympiadGameTask;
import org.l2jpx.gameserver.model.olympiad.OlympiadManager;
import org.l2jpx.gameserver.model.punishment.PunishmentAffect;
import org.l2jpx.gameserver.model.punishment.PunishmentType;
import org.l2jpx.gameserver.model.quest.Quest;
import org.l2jpx.gameserver.model.quest.QuestState;
import org.l2jpx.gameserver.model.quest.QuestTimer;
import org.l2jpx.gameserver.model.sevensigns.SevenSigns;
import org.l2jpx.gameserver.model.sevensigns.SevenSignsFestival;
import org.l2jpx.gameserver.model.siege.Castle;
import org.l2jpx.gameserver.model.siege.Fort;
import org.l2jpx.gameserver.model.siege.Siege;
...
import org.l2jpx.gameserver.model.skill.SkillCaster;
import org.l2jpx.gameserver.model.skill.SkillCastingType;
import org.l2jpx.gameserver.model.skill.targets.TargetType;
import org.l2jpx.gameserver.model.stats.BaseStat;
import org.l2jpx.gameserver.model.stats.Formulas;
import org.l2jpx.gameserver.model.stats.MoveType;
import org.l2jpx.gameserver.model.stats.Stat;
import org.l2jpx.gameserver.model.variables.AccountVariables;
import org.l2jpx.gameserver.model.variables.PlayerVariables;
import org.l2jpx.gameserver.model.zone.ZoneId;
import org.l2jpx.gameserver.model.zone.ZoneRegion;
import org.l2jpx.gameserver.model.zone.ZoneType;
import org.l2jpx.gameserver.model.zone.type.WaterZone;
...
import org.l2jpx.gameserver.network.serverpackets.AbstractHtmlPacket;
import org.l2jpx.gameserver.network.serverpackets.AcquireSkillList;
import org.l2jpx.gameserver.network.serverpackets.ActionFailed;
import org.l2jpx.gameserver.network.serverpackets.ChangeWaitType;
import org.l2jpx.gameserver.network.serverpackets.CharInfo;
import org.l2jpx.gameserver.network.serverpackets.ConfirmDlg;
import org.l2jpx.gameserver.network.serverpackets.EtcStatusUpdate;
import org.l2jpx.gameserver.network.serverpackets.ExAbnormalStatusUpdateFromTarget;
import org.l2jpx.gameserver.network.serverpackets.ExAdenaInvenCount;
import org.l2jpx.gameserver.network.serverpackets.ExAutoSoulShot;
import org.l2jpx.gameserver.network.serverpackets.ExBrPremiumState;
import org.l2jpx.gameserver.network.serverpackets.ExDuelUpdateUserInfo;
import org.l2jpx.gameserver.network.serverpackets.ExGetBookMarkInfoPacket;
import org.l2jpx.gameserver.network.serverpackets.ExGetOnAirShip;
import org.l2jpx.gameserver.network.serverpackets.ExMagicAttackInfo;
import org.l2jpx.gameserver.network.serverpackets.ExOlympiadMode;
import org.l2jpx.gameserver.network.serverpackets.ExPledgeCount;
import org.l2jpx.gameserver.network.serverpackets.ExPrivateStoreSetWholeMsg;
import org.l2jpx.gameserver.network.serverpackets.ExQuestItemList;
import org.l2jpx.gameserver.network.serverpackets.ExSetCompassZoneCode;
import org.l2jpx.gameserver.network.serverpackets.ExStartScenePlayer;
import org.l2jpx.gameserver.network.serverpackets.ExStopScenePlayer;
import org.l2jpx.gameserver.network.serverpackets.ExStorageMaxCount;
import org.l2jpx.gameserver.network.serverpackets.ExSubjobInfo;
import org.l2jpx.gameserver.network.serverpackets.ExUseSharedGroupItem;
import org.l2jpx.gameserver.network.serverpackets.ExUserInfoAbnormalVisualEffect;
import org.l2jpx.gameserver.network.serverpackets.ExUserInfoCubic;
import org.l2jpx.gameserver.network.serverpackets.ExUserInfoEquipSlot;
import org.l2jpx.gameserver.network.serverpackets.ExUserInfoInvenWeight;
import org.l2jpx.gameserver.network.serverpackets.GetOnVehicle;
import org.l2jpx.gameserver.network.serverpackets.HennaInfo;
import org.l2jpx.gameserver.network.serverpackets.InventoryUpdate;
import org.l2jpx.gameserver.network.serverpackets.ItemList;
...
import org.l2jpx.gameserver.network.serverpackets.MyTargetSelected;
import org.l2jpx.gameserver.network.serverpackets.NicknameChanged;
import org.l2jpx.gameserver.network.serverpackets.ObservationMode;
import org.l2jpx.gameserver.network.serverpackets.ObservationReturn;
import org.l2jpx.gameserver.network.serverpackets.PartySmallWindowUpdate;
import org.l2jpx.gameserver.network.serverpackets.PetInventoryUpdate;
import org.l2jpx.gameserver.network.serverpackets.PledgeShowMemberListDelete;
import org.l2jpx.gameserver.network.serverpackets.PledgeShowMemberListUpdate;
import org.l2jpx.gameserver.network.serverpackets.PrivateStoreListBuy;
import org.l2jpx.gameserver.network.serverpackets.PrivateStoreListSell;
import org.l2jpx.gameserver.network.serverpackets.PrivateStoreManageListBuy;
import org.l2jpx.gameserver.network.serverpackets.PrivateStoreMsgBuy;
import org.l2jpx.gameserver.network.serverpackets.PrivateStoreMsgSell;
import org.l2jpx.gameserver.network.serverpackets.RecipeShopMsg;
import org.l2jpx.gameserver.network.serverpackets.RecipeShopSellList;
import org.l2jpx.gameserver.network.serverpackets.RelationChanged;
import org.l2jpx.gameserver.network.serverpackets.Ride;
import org.l2jpx.gameserver.network.serverpackets.ServerPacket;
import org.l2jpx.gameserver.network.serverpackets.SetupGauge;
import org.l2jpx.gameserver.network.serverpackets.ShortCutInit;
import org.l2jpx.gameserver.network.serverpackets.SkillCoolTime;
import org.l2jpx.gameserver.network.serverpackets.SkillList;
import org.l2jpx.gameserver.network.serverpackets.Snoop;
import org.l2jpx.gameserver.network.serverpackets.SocialAction;
import org.l2jpx.gameserver.network.serverpackets.StatusUpdate;
import org.l2jpx.gameserver.network.serverpackets.StopMove;
import org.l2jpx.gameserver.network.serverpackets.SystemMessage;
import org.l2jpx.gameserver.network.serverpackets.TargetSelected;
import org.l2jpx.gameserver.network.serverpackets.TargetUnselected;
import org.l2jpx.gameserver.network.serverpackets.TradeDone;
import org.l2jpx.gameserver.network.serverpackets.TradeOtherDone;
import org.l2jpx.gameserver.network.serverpackets.TradeStart;
import org.l2jpx.gameserver.network.serverpackets.UserInfo;
import org.l2jpx.gameserver.network.serverpackets.ValidateLocation;
import org.l2jpx.gameserver.network.serverpackets.commission.ExResponseCommissionInfo;
import org.l2jpx.gameserver.network.serverpackets.friend.FriendStatus;
import org.l2jpx.gameserver.taskmanager.AttackStanceTaskManager;
import org.l2jpx.gameserver.taskmanager.AutoPlayTaskManager;
import org.l2jpx.gameserver.taskmanager.AutoUseTaskManager;
import org.l2jpx.gameserver.taskmanager.DecayTaskManager;
import org.l2jpx.gameserver.taskmanager.GameTimeTaskManager;
import org.l2jpx.gameserver.taskmanager.ItemsAutoDestroyTaskManager;
import org.l2jpx.gameserver.taskmanager.PlayerAutoSaveTaskManager;
import org.l2jpx.gameserver.taskmanager.PvpFlagTaskManager;
import org.l2jpx.gameserver.util.Broadcast;
import org.l2jpx.gameserver.util.EnumIntBitmask;
