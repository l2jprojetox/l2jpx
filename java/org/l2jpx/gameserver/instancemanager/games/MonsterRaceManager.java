 ...
 */
package org.l2jpx.gameserver.instancemanager.games;
...
import org.l2jpx.gameserver.network.serverpackets.MonRaceInfo;
	...
	public void newRace()
	{
		...
		for (int i = 0; i < 8; i++)
		{
			try
			{
				...
				_monsters[i] = (Npc) Class.forName("org.l2jpx.gameserver.model.actor.instance." + template.getType()).getConstructors()[0].newInstance(template);
			}
			catch (Exception e)
			{
