 ...
 */
package org.l2jpx.gameserver.util;
...
import org.l2jpx.gameserver.enums.PlayerState;
import org.l2jpx.gameserver.enums.Race;
import org.l2jpx.gameserver.model.StatSet;
import org.l2jpx.gameserver.model.conditions.Condition;
import org.l2jpx.gameserver.model.conditions.ConditionCategoryType;
import org.l2jpx.gameserver.model.conditions.ConditionChangeWeapon;
import org.l2jpx.gameserver.model.conditions.ConditionGameChance;
import org.l2jpx.gameserver.model.conditions.ConditionGameTime;
import org.l2jpx.gameserver.model.conditions.ConditionLogicAnd;
import org.l2jpx.gameserver.model.conditions.ConditionLogicNot;
import org.l2jpx.gameserver.model.conditions.ConditionLogicOr;
import org.l2jpx.gameserver.model.conditions.ConditionMinDistance;
import org.l2jpx.gameserver.model.conditions.ConditionMinimumVitalityPoints;
import org.l2jpx.gameserver.model.conditions.ConditionPlayerActiveEffectId;
import org.l2jpx.gameserver.model.conditions.ConditionPlayerActiveSkillId;
import org.l2jpx.gameserver.model.conditions.ConditionPlayerAgathionId;
import org.l2jpx.gameserver.model.conditions.ConditionPlayerCallPc;
import org.l2jpx.gameserver.model.conditions.ConditionPlayerCanCreateBase;
import org.l2jpx.gameserver.model.conditions.ConditionPlayerCanEscape;
import org.l2jpx.gameserver.model.conditions.ConditionPlayerCanRefuelAirship;
import org.l2jpx.gameserver.model.conditions.ConditionPlayerCanResurrect;
import org.l2jpx.gameserver.model.conditions.ConditionPlayerCanSummonPet;
import org.l2jpx.gameserver.model.conditions.ConditionPlayerCanSummonServitor;
import org.l2jpx.gameserver.model.conditions.ConditionPlayerCanSummonSiegeGolem;
import org.l2jpx.gameserver.model.conditions.ConditionPlayerCanSweep;
import org.l2jpx.gameserver.model.conditions.ConditionPlayerCanSwitchSubclass;
import org.l2jpx.gameserver.model.conditions.ConditionPlayerCanTakeCastle;
import org.l2jpx.gameserver.model.conditions.ConditionPlayerCanTakeFort;
import org.l2jpx.gameserver.model.conditions.ConditionPlayerCanTransform;
import org.l2jpx.gameserver.model.conditions.ConditionPlayerCanUntransform;
import org.l2jpx.gameserver.model.conditions.ConditionPlayerCharges;
import org.l2jpx.gameserver.model.conditions.ConditionPlayerCheckAbnormal;
import org.l2jpx.gameserver.model.conditions.ConditionPlayerClassIdRestriction;
import org.l2jpx.gameserver.model.conditions.ConditionPlayerCloakStatus;
import org.l2jpx.gameserver.model.conditions.ConditionPlayerCp;
import org.l2jpx.gameserver.model.conditions.ConditionPlayerDualclass;
import org.l2jpx.gameserver.model.conditions.ConditionPlayerFlyMounted;
import org.l2jpx.gameserver.model.conditions.ConditionPlayerHasCastle;
import org.l2jpx.gameserver.model.conditions.ConditionPlayerHasClanHall;
import org.l2jpx.gameserver.model.conditions.ConditionPlayerHasFort;
import org.l2jpx.gameserver.model.conditions.ConditionPlayerHasFreeSummonPoints;
import org.l2jpx.gameserver.model.conditions.ConditionPlayerHasFreeTeleportBookmarkSlots;
import org.l2jpx.gameserver.model.conditions.ConditionPlayerHasPet;
import org.l2jpx.gameserver.model.conditions.ConditionPlayerHasSummon;
import org.l2jpx.gameserver.model.conditions.ConditionPlayerHp;
import org.l2jpx.gameserver.model.conditions.ConditionPlayerImmobile;
import org.l2jpx.gameserver.model.conditions.ConditionPlayerInInstance;
import org.l2jpx.gameserver.model.conditions.ConditionPlayerInsideZoneId;
import org.l2jpx.gameserver.model.conditions.ConditionPlayerInstanceId;
import org.l2jpx.gameserver.model.conditions.ConditionPlayerInvSize;
import org.l2jpx.gameserver.model.conditions.ConditionPlayerIsClanLeader;
import org.l2jpx.gameserver.model.conditions.ConditionPlayerIsHero;
import org.l2jpx.gameserver.model.conditions.ConditionPlayerIsInCombat;
import org.l2jpx.gameserver.model.conditions.ConditionPlayerIsOnSide;
import org.l2jpx.gameserver.model.conditions.ConditionPlayerIsPvpFlagged;
import org.l2jpx.gameserver.model.conditions.ConditionPlayerLandingZone;
import org.l2jpx.gameserver.model.conditions.ConditionPlayerLevel;
import org.l2jpx.gameserver.model.conditions.ConditionPlayerLevelRange;
import org.l2jpx.gameserver.model.conditions.ConditionPlayerMp;
import org.l2jpx.gameserver.model.conditions.ConditionPlayerPkCount;
import org.l2jpx.gameserver.model.conditions.ConditionPlayerPledgeClass;
import org.l2jpx.gameserver.model.conditions.ConditionPlayerRace;
import org.l2jpx.gameserver.model.conditions.ConditionPlayerRangeFromNpc;
import org.l2jpx.gameserver.model.conditions.ConditionPlayerRangeFromSummonedNpc;
import org.l2jpx.gameserver.model.conditions.ConditionPlayerServitorNpcId;
import org.l2jpx.gameserver.model.conditions.ConditionPlayerSex;
import org.l2jpx.gameserver.model.conditions.ConditionPlayerSiegeSide;
import org.l2jpx.gameserver.model.conditions.ConditionPlayerSouls;
import org.l2jpx.gameserver.model.conditions.ConditionPlayerState;
import org.l2jpx.gameserver.model.conditions.ConditionPlayerSubclass;
import org.l2jpx.gameserver.model.conditions.ConditionPlayerTransformationId;
import org.l2jpx.gameserver.model.conditions.ConditionPlayerVehicleMounted;
import org.l2jpx.gameserver.model.conditions.ConditionPlayerWeight;
import org.l2jpx.gameserver.model.conditions.ConditionSiegeZone;
import org.l2jpx.gameserver.model.conditions.ConditionSlotItemId;
import org.l2jpx.gameserver.model.conditions.ConditionTargetAbnormalType;
import org.l2jpx.gameserver.model.conditions.ConditionTargetActiveEffectId;
import org.l2jpx.gameserver.model.conditions.ConditionTargetActiveSkillId;
import org.l2jpx.gameserver.model.conditions.ConditionTargetAggro;
import org.l2jpx.gameserver.model.conditions.ConditionTargetCheckCrtEffect;
import org.l2jpx.gameserver.model.conditions.ConditionTargetClassIdRestriction;
import org.l2jpx.gameserver.model.conditions.ConditionTargetInvSize;
import org.l2jpx.gameserver.model.conditions.ConditionTargetLevel;
import org.l2jpx.gameserver.model.conditions.ConditionTargetLevelRange;
import org.l2jpx.gameserver.model.conditions.ConditionTargetMyPartyExceptMe;
import org.l2jpx.gameserver.model.conditions.ConditionTargetNpcId;
import org.l2jpx.gameserver.model.conditions.ConditionTargetNpcType;
import org.l2jpx.gameserver.model.conditions.ConditionTargetPlayable;
import org.l2jpx.gameserver.model.conditions.ConditionTargetPlayer;
import org.l2jpx.gameserver.model.conditions.ConditionTargetRace;
import org.l2jpx.gameserver.model.conditions.ConditionTargetUsesWeaponKind;
import org.l2jpx.gameserver.model.conditions.ConditionTargetWeight;
import org.l2jpx.gameserver.model.conditions.ConditionUsingItemType;
import org.l2jpx.gameserver.model.conditions.ConditionUsingSkill;
import org.l2jpx.gameserver.model.conditions.ConditionUsingSlotType;
import org.l2jpx.gameserver.model.conditions.ConditionWithSkill;
...
import org.l2jpx.gameserver.model.stats.functions.FuncTemplate;
