package com.px.gameserver.scripting.scripts.ai;
...
public class L2AttackableAIScript extends Quest
{
	...
	protected void registerNpcs()
	{
		...
		for (NpcTemplate template : NpcData.getInstance().getAllNpcs())
		{
			try
			{
				if (Attackable.class.isAssignableFrom(Class.forName("com.px.gameserver.model.actor.instance." + template.getType())))
				{
