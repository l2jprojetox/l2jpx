...
public final class L2Spawn implements Runnable
{
	...
	public L2Spawn(NpcTemplate template) throws SecurityException, ClassNotFoundException, NoSuchMethodException
	{
		...
		{
			int.class,
			Class.forName("com.px.gameserver.model.actor.template.NpcTemplate")
		};
		_constructor = Class.forName("com.px.gameserver.model.actor.instance." + _template.getType()).getConstructor(parameters);
	}
