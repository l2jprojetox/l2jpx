...
from net.l2jpx.gameserver.datatables.sql import NpcTable
from net.l2jpx.gameserver.idfactory import IdFactory
from net.l2jpx.gameserver.model.actor.instance import L2TamedBeastInstance
