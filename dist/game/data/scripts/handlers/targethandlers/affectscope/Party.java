...
import org.l2jpx.gameserver.handler.IAffectObjectHandler;
...
public class Party implements IAffectScopeHandler
{
	...
	public void forEachAffected(Creature creature, WorldObject target, Skill skill, Consumer<? super WorldObject> action)
	{
		...
		if (target.isPlayable())
		{
			...
			final org.l2jpx.gameserver.model.Party party = player.getParty();
			...
			final Predicate<Playable> filter = plbl ->
			{
				...
				if (p != player)
				{
					final org.l2jpx.gameserver.model.Party targetParty = p.getParty();
