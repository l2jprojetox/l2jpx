...
import net.l2jpx.crypt.LoginCrypt;
import net.l2jpx.crypt.ScrambledKeyPair;
import net.l2jpx.loginserver.network.serverpackets.L2LoginServerPacket;
import net.l2jpx.loginserver.network.serverpackets.LoginFail;
import net.l2jpx.loginserver.network.serverpackets.LoginFail.LoginFailReason;
import net.l2jpx.loginserver.network.serverpackets.PlayFail;
import net.l2jpx.loginserver.network.serverpackets.PlayFail.PlayFailReason;
import net.l2jpx.netcore.MMOClient;
