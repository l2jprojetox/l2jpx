...
import net.l2jpx.gameserver.network.serverpackets.GameGuardQuery;
...
public class nProtect
{
	...
	private nProtect()
	{
		...
		try
		{
			clazz = Class.forName("net.l2jpx.protection.main");
		...
		catch (final ClassNotFoundException e)
		{
			if (Config.DEBUG)
			{
				LOGGER.warn("nProtect System will be not loaded due to ClassNotFoundException of 'net.l2jpx.protection.main' class");
			}
		}
