package net.l2jpx.gameserver.ai;

import static net.l2jpx.gameserver.ai.CtrlIntention.AI_INTENTION_ACTIVE;
import static net.l2jpx.gameserver.ai.CtrlIntention.AI_INTENTION_ATTACK;
import static net.l2jpx.gameserver.ai.CtrlIntention.AI_INTENTION_CAST;
import static net.l2jpx.gameserver.ai.CtrlIntention.AI_INTENTION_FOLLOW;
import static net.l2jpx.gameserver.ai.CtrlIntention.AI_INTENTION_IDLE;
import static net.l2jpx.gameserver.ai.CtrlIntention.AI_INTENTION_INTERACT;
import static net.l2jpx.gameserver.ai.CtrlIntention.AI_INTENTION_MOVE_TO;
import static net.l2jpx.gameserver.ai.CtrlIntention.AI_INTENTION_PICK_UP;
import static net.l2jpx.gameserver.ai.CtrlIntention.AI_INTENTION_REST;

import net.l2jpx.gameserver.ai.L2PlayerAI.IntentionCommand;
...
import net.l2jpx.gameserver.network.serverpackets.AutoAttackStop;
...
public class L2CharacterAI extends AbstractAI
{
	...
	/**
	 * @see net.l2jpx.gameserver.ai.AbstractAI#onIntentionActive()
	 */
	@Override
