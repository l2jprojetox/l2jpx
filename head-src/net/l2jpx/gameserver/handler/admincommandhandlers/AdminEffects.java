...
import net.l2jpx.gameserver.network.serverpackets.ExRedSky;
...
import net.l2jpx.gameserver.network.serverpackets.SunRise;
import net.l2jpx.gameserver.network.serverpackets.SunSet;
