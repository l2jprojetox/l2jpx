...
import net.l2jpx.gameserver.communitybbs.BB.Post;
import net.l2jpx.gameserver.communitybbs.BB.Post.CPost;
import net.l2jpx.gameserver.communitybbs.BB.Topic;
