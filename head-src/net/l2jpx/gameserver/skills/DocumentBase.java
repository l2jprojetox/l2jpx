...
import net.l2jpx.gameserver.skills.conditions.Condition;
import net.l2jpx.gameserver.skills.conditions.ConditionElementSeed;
import net.l2jpx.gameserver.skills.conditions.ConditionForceBuff;
import net.l2jpx.gameserver.skills.conditions.ConditionGameChance;
import net.l2jpx.gameserver.skills.conditions.ConditionGameTime;
import net.l2jpx.gameserver.skills.conditions.ConditionGameTime.CheckGameTime;
import net.l2jpx.gameserver.skills.conditions.ConditionLogicAnd;
import net.l2jpx.gameserver.skills.conditions.ConditionLogicNot;
import net.l2jpx.gameserver.skills.conditions.ConditionLogicOr;
import net.l2jpx.gameserver.skills.conditions.ConditionPlayerClassIdRestriction;
import net.l2jpx.gameserver.skills.conditions.ConditionPlayerHp;
import net.l2jpx.gameserver.skills.conditions.ConditionPlayerHpPercentage;
import net.l2jpx.gameserver.skills.conditions.ConditionPlayerLevel;
import net.l2jpx.gameserver.skills.conditions.ConditionPlayerMp;
import net.l2jpx.gameserver.skills.conditions.ConditionPlayerRace;
import net.l2jpx.gameserver.skills.conditions.ConditionPlayerState;
import net.l2jpx.gameserver.skills.conditions.ConditionPlayerState.CheckPlayerState;
import net.l2jpx.gameserver.skills.conditions.ConditionSkillStats;
import net.l2jpx.gameserver.skills.conditions.ConditionSlotItemId;
import net.l2jpx.gameserver.skills.conditions.ConditionTargetAggro;
import net.l2jpx.gameserver.skills.conditions.ConditionTargetClassIdRestriction;
import net.l2jpx.gameserver.skills.conditions.ConditionTargetLevel;
import net.l2jpx.gameserver.skills.conditions.ConditionTargetRaceId;
import net.l2jpx.gameserver.skills.conditions.ConditionTargetUsesWeaponKind;
import net.l2jpx.gameserver.skills.conditions.ConditionUsingItemType;
import net.l2jpx.gameserver.skills.conditions.ConditionUsingSkill;
import net.l2jpx.gameserver.skills.conditions.ConditionWithSkill;
import net.l2jpx.gameserver.skills.effects.EffectTemplate;
import net.l2jpx.gameserver.skills.funcs.FuncTemplate;
import net.l2jpx.gameserver.skills.funcs.Lambda;
import net.l2jpx.gameserver.skills.funcs.LambdaCalc;
import net.l2jpx.gameserver.skills.funcs.LambdaConst;
import net.l2jpx.gameserver.skills.funcs.LambdaStats;
