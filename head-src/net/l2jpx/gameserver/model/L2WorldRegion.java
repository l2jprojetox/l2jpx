...
import net.l2jpx.gameserver.model.zone.L2ZoneManager;
import net.l2jpx.gameserver.model.zone.L2ZoneType;
import net.l2jpx.gameserver.model.zone.type.L2PeaceZone;
import net.l2jpx.gameserver.thread.ThreadPoolManager;
import net.l2jpx.util.object.L2ObjectSet;
			...
			for (final L2Object o : visibleObjects)
			{
				if (o instanceof L2Attackable)
				{
					...
					if (mob.getAI() != null)
					{
						...
						mob.getAI().setIntention(net.l2jpx.gameserver.ai.CtrlIntention.AI_INTENTION_IDLE);
