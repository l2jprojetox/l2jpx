...
import net.l2jpx.gameserver.ai.L2FortSiegeGuardAI;
import net.l2jpx.gameserver.ai.L2SiegeGuardAI;
...
import net.l2jpx.gameserver.model.actor.knownlist.AttackableKnownList;
import net.l2jpx.gameserver.model.base.SoulCrystal;
import net.l2jpx.gameserver.model.holder.AggroInfoHolder;
import net.l2jpx.gameserver.model.holder.RewardHolder;
import net.l2jpx.gameserver.model.holder.RewardInfoHolder;
...
public class L2Attackable extends L2NpcInstance
{
	...
	public L2ItemInstance dropItem(final L2PcInstance mainDamageDealer, final RewardHolder item)
	{
		...
		for (int i = 0; i < item.getRewardCount(); i++)
		{
			...
			ditem.setInstance(getInstance(), false);
	...
	public L2ItemInstance dropItem(final L2PcInstance lastAttacker, final int itemId, int itemCount, final int enchantLevel)
	{
		// Assumindo que a chance não é necessária ou usa um valor padrão definido em RewardHolder.
		int defaultChance = 100; // Valor padrão de chance, ajuste conforme necessário.
		return dropItem(lastAttacker, new RewardHolder(itemId, itemCount, defaultChance, enchantLevel));
	}
