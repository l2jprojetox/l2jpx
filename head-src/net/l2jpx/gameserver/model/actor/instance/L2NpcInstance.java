...
import net.l2jpx.gameserver.datatables.MobGroupTable;
...
import net.l2jpx.gameserver.managers.CustomNpcInstanceManager;
...
import net.l2jpx.gameserver.model.actor.stat.NpcStat;
import net.l2jpx.gameserver.model.actor.status.NpcStatus;
import net.l2jpx.gameserver.model.entity.event.Lottery;
...
import net.l2jpx.gameserver.model.scripts.L2RBManager;
...
import net.l2jpx.gameserver.network.serverpackets.ExShowVariationCancelWindow;
import net.l2jpx.gameserver.network.serverpackets.ExShowVariationMakeWindow;
