...
import net.l2jpx.gameserver.ai.L2SummonAI;
...
import net.l2jpx.gameserver.model.actor.knownlist.SummonKnownList;
import net.l2jpx.gameserver.model.actor.stat.SummonStat;
import net.l2jpx.gameserver.model.actor.status.SummonStatus;
...
import net.l2jpx.gameserver.network.serverpackets.PetDelete;
import net.l2jpx.gameserver.network.serverpackets.PetStatusShow;
import net.l2jpx.gameserver.network.serverpackets.PetStatusUpdate;
...
public abstract class L2Summon extends L2PlayableInstance
{
	 ...
	 */
	public boolean useMagic(L2Skill skill, final boolean forceUse, final boolean dontMove)
	{
	 ...
	 * @see net.l2jpx.gameserver.model.L2Character#doCast(net.l2jpx.gameserver.model.L2Skill)
	 */
	@Override
	...
	{
	    return SkillTable.getInstance().getInfo(skillId, 1);
	}
