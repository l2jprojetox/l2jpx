...
import static net.l2jpx.gameserver.taskmanager.TaskTypes.TYPE_FIXED_SHEDULED;
import static net.l2jpx.gameserver.taskmanager.TaskTypes.TYPE_GLOBAL_TASK;
import static net.l2jpx.gameserver.taskmanager.TaskTypes.TYPE_NONE;
import static net.l2jpx.gameserver.taskmanager.TaskTypes.TYPE_SHEDULED;
import static net.l2jpx.gameserver.taskmanager.TaskTypes.TYPE_SPECIAL;
import static net.l2jpx.gameserver.taskmanager.TaskTypes.TYPE_STARTUP;
import static net.l2jpx.gameserver.taskmanager.TaskTypes.TYPE_TIME;
...
import net.l2jpx.gameserver.taskmanager.tasks.TaskRaidPointsReset;
import net.l2jpx.gameserver.taskmanager.tasks.TaskRecom;
import net.l2jpx.gameserver.taskmanager.tasks.TaskRestart;
import net.l2jpx.gameserver.taskmanager.tasks.TaskSevenSignsUpdate;
import net.l2jpx.gameserver.taskmanager.tasks.TaskShutdown;
