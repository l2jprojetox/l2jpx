...
public class WorldObjectTree<T extends L2Object> extends L2ObjectMap<T>
{
	...
	/**
	 * @see net.l2jpx.util.object.L2ObjectMap#size()
	 */
	@Override
	public int size()
	{
	...
	/**
	 * @see net.l2jpx.util.object.L2ObjectMap#isEmpty()
	 */
	@Override
	...
	/**
	 * @see net.l2jpx.util.object.L2ObjectMap#clear()
	 */
	@Override
	public void clear()
	{
	...
	/**
	 * @see net.l2jpx.util.object.L2ObjectMap#get(int)
	 */
	@Override
	...
	/**
	 * @see net.l2jpx.util.object.L2ObjectMap#iterator()
	 */
	@Override
